...
[Solution Link](https://countries-challenge.vercel.app/)

## Welcome! 👋

:construction: This challenge is a work in progress.

## The challenge

### What did I learn? 

- Integrated the the [REST Countries API](https://restcountries.com/) to pull country data and display it like in the designs.
- Used Angular as framework for the front-end. 
- Learned and practiced grid system to build the layout.
